...
<!--          <a href="ListLecture">Lecture Manager</a>-->
    ...
    <table>
        ...
        <c:forEach var="lecture" items="${requestScope.lectureInfo}">
            <tr>
                <td>${lecture.id}</td>
                <td>${lecture.name}</td>
                <td><a href="SendFeedbackToLecture?idLectures=${lecture.id}&idStudents=<%= id%>">Send feedback Lecture</a></td>
                <td><a href="ListFeedbackByLectureId?idLectures=${lecture.id}&idStudents=<%= id%>">View feedback Lecture</a></td>
            </tr>
        </c:forEach>
    </table>
    <a href="home?idStudents=<%= id %>">Back to Lecture Home</a>
        </div>
</body>
</html>
