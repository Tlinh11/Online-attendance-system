...
<html>
    ...
    <body>
        <header class="text-blue-700 body-font border-b border-gray-200">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a class="flex title-font font-medium items-center text-blue-900 mb-4 md:mb-0" href="#" >
                    ...
                    <span class="ml-3 text-blue-500 text-xl">Online Attendance System</span>
                </a>
                <div class="info-box">
            <% 
            ...
            %>
                ...
                <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <a class="mr-5 hover:text-blue-900" href="timetable?id=<%=id%>">Weekly TimeTable</a>
                                        <a class="mr-5 hover:text-blue-900" href="info">Student information</a>
                    <a class="mr-5 hover:text-blue-900" href="checkabsent">Attendance report</a>
                    <a class="mr-5 hover:text-blue-900" href="ListLectureEachStudent?id=<%=id%>">Send Feedback</a>
                    <a class="mr-5 hover:text-blue-900" href="../LogOut">Log out</a>
                </nav>
            </div>
        </header>
        ...
        <section class="text-gray-700 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">View attendance for today's class
                    </h1>
                    <p class="mb-8 leading-relaxed"></p>
                    <div class="flex justify-center">
                        <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">View Attendance</button>
                    </div>
                </div>
            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                    ...
                    <p class="leading-relaxed text-lg"> 
                        With the need to apply technology to education, we always want to bring the best products to develop education. The OAS will likely be a landmark system that changes education around the world. Let's develop education with IT revolutions!</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
                    <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">Author</h2>
                    <p class="text-gray-500">OAS Development Team</p>
                </div>
            </div>
        </section>
    </body>
