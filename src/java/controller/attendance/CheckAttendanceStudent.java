...
public class CheckAttendanceStudent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Group> getTermOfStudentLearned = mdb.getTermOfStudentLearned(a.getEmail());
        ...
        ArrayList<Group> selectTermGetCourse = mdb.getSelectTermToSeeMark(a.getEmail(), getTermID);
        ...
        ArrayList<Attendance> attendanceStatusForAll = adbc.getAttendanceStatusForAll(getCourseid, getTermID, a.getEmail());
        request.setAttribute("attendance", attendanceStatusForAll);
        request.setAttribute("test", attendanceStatusForAll.size());
        String totalAbsent = adbc.getTotalAbsent(a.getEmail(), getCourseid, getTermID);
